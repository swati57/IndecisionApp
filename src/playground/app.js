...
//faster than class based component and used to replace simple class
//use class when state needs to be worked on
//use stless fun comp when just render needed 
